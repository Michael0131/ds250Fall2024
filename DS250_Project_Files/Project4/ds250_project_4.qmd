...
plt.figure(figsize=(10, 10))  # Adjust height to space out labels
sns.barplot(data=importance_df, x='Importance', y='Feature', palette='viridis')
plt.title('Feature Importance for Predicting Before1980', fontsize=16)
...
plt.close()  # Close the figure to prevent automatic rendering

# ---- Display Results in HTML ----
# Render table of feature importance
html_table = importance_df.to_html(classes="table table-bordered", index=False)
display(HTML(f"""
